                ...
                <div className="fixed inset-0 z-[60] bg-slate-900/50 backdrop-blur-sm md:hidden">
                    <div className="absolute top-0 left-0 bottom-0 w-[280px] bg-white shadow-2xl animate-in slide-in-from-left duration-300 flex flex-col">
                        ...
                        <div className="flex-1 overflow-y-auto py-4 px-3 flex flex-col gap-1">
                            ...
                            <Link onClick={() => setIsMenuOpen(false)} href="/legal/privacy" className="px-4 py-2.5 text-slate-600 hover:bg-slate-50 rounded-lg text-sm block">Privacy Policy</Link>
                            <Link onClick={() => setIsMenuOpen(false)} href="/legal/terms" className="px-4 py-2.5 text-slate-600 hover:bg-slate-50 rounded-lg text-sm block">Terms of Service</Link>
                            <Link onClick={() => setIsMenuOpen(false)} href="/legal/refund" className="px-4 py-2.5 text-slate-600 hover:bg-slate-50 rounded-lg text-sm block">Refund & Warranty</Link>
                        </div>
